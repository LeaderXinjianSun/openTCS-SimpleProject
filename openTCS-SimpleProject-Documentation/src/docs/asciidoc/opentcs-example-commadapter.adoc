...
----
include::{common-javaSrc}/com/sxj/common/telegrams/Telegram.java[tags=documentation_checksumComp]
----
...
|operationState
|_char_
|Current operation state: **_I_**dle, **_C_**harging, **_M_**oving, **_A_**cting, **_E_**rror
