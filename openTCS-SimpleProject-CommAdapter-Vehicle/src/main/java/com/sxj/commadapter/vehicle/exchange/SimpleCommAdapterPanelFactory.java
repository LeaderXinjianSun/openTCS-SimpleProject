 ...
 */
public class SimpleCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(SimpleCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public SimpleCommAdapterPanelFactory(KernelServicePortal servicePortal,
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((SimpleProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((SimpleProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof SimpleCommAdapterDescription)
        && (processModel instanceof SimpleProcessModelTO);
  }
}
