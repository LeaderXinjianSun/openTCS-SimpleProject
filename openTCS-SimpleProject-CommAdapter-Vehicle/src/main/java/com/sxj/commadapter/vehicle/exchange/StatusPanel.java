...
import com.sxj.commadapter.vehicle.exchange.commands.SetPeriodicStateRequestEnabledCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetStateRequestIntervalCommand;
...
public class StatusPanel
  ...
  private static final ResourceBundle resourceBundle
      = ResourceBundle.getBundle("com/sxj/commadapter/vehicle/Bundle");
  /**
   ...
   */
  @Inject
  public StatusPanel(@Assisted SimpleProcessModelTO processModel,
  ...
  public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
    ...
    if (Objects.equals(attributeChanged,
      ...
      updateCommAdapterConnected(processModel.isCommAdapterConnected());
                            ...
                            SimpleProcessModel.Attribute.CURRENT_STATE.name())) {
