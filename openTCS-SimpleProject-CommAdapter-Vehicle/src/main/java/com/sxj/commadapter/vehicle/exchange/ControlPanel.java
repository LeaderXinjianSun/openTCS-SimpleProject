...
import com.sxj.commadapter.vehicle.SimpleProcessModel;
import com.sxj.commadapter.vehicle.exchange.commands.SendRequestCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetDisconnectingOnVehicleIdleCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetIdleTimeoutCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetLoggingEnabledCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetReconnectingOnConnectionLossCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetVehicleHostCommand;
import com.sxj.commadapter.vehicle.exchange.commands.SetVehiclePortCommand;
...
public class ControlPanel
   ...
   */
  private SimpleProcessModelTO processModel;
   ...
   */
  @Inject
  public ControlPanel(@Assisted SimpleProcessModelTO processModel,
  ...
  private void initGuiContent() {
    ...
    for (SimpleProcessModel.Attribute attribute : SimpleProcessModel.Attribute.values()) {
      processModelChange(attribute.name(), processModel);
    }
  }
  ...
  public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
    if (!(newProcessModel instanceof SimpleProcessModelTO)) {
      return;
    }
    processModel = (SimpleProcessModelTO) newProcessModel;
    ...
    else if (Objects.equals(attributeChanged, SimpleProcessModel.Attribute.VEHICLE_HOST.name())) {
      updateVehicleHost(processModel.getVehicleHost());
    }
    else if (Objects.equals(attributeChanged, SimpleProcessModel.Attribute.VEHICLE_PORT.name())) {
      updateVehiclePort(processModel.getVehiclePort());
    }
    else if (Objects.equals(attributeChanged,
                            SimpleProcessModel.Attribute.VEHICLE_IDLE_TIMEOUT.name())) {
      updateVehicleTimeout(processModel.getVehicleIdleTimeout());
    }
    else if (Objects.equals(attributeChanged, SimpleProcessModel.Attribute.VEHICLE_IDLE.name())) {
      updateVehicleIdle(processModel.isVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
                            SimpleProcessModel.Attribute.DISCONNECTING_ON_IDLE.name())) {
      updateDisconnectingOnIdle(processModel.isDisconnectingOnVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
                            SimpleProcessModel.Attribute.RECONNECTING_ON_CONNECTION_LOSS.name())) {
      updateReconnectingOnConnectionLoss(processModel.isReconnectingOnConnectionLoss());
    }
    else if (Objects.equals(attributeChanged, SimpleProcessModel.Attribute.LAST_ORDER.name())) {
      updateLastOrder(processModel.getLastOrderSent(), processModel.isCommAdapterConnected());
    }
    else if (Objects.equals(attributeChanged,
                            SimpleProcessModel.Attribute.LOGGING_ENABLED.name())) {
  ...
  private void initComponents() {
    ...
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/sxj/commadapter/vehicle/Bundle"); // NOI18N
    ...
    connectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDGray.gif"))); // NOI18N
    connectedButton.setText(bundle.getString("AdapterConnected")); // NOI18N
    connectedButton.setBorderPainted(false);
    connectedButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDRed.gif"))); // NOI18N
    connectedButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  activeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDGray.gif"))); // NOI18N
  activeButton.setText(bundle.getString("ControlPanel.AdapterActive")); // NOI18N
  activeButton.setBorderPainted(false);
  activeButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDRed.gif"))); // NOI18N
  activeButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sxj/commadapter/vehicle/res/symbols/LEDGreen.gif"))); // NOI18N
