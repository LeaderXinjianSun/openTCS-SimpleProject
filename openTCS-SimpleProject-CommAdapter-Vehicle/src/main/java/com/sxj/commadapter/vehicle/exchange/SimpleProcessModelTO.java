...
/**
 * A serializable representation of a {@link SimpleProcessModel}.
 ...
 */
public class SimpleProcessModelTO
   ...
   * @return This
   */
  public SimpleProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public SimpleProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public SimpleProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public SimpleProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public SimpleProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
