 ...
 */
public class SimpleCommAdapterFactoryTest {

  private SimpleCommAdapterFactory commAdapterFactory;

  @Before
  public void setUp() {
    commAdapterFactory = new SimpleCommAdapterFactory(mock(SimpleAdapterComponentsFactory.class));
  }
